...
def fun1():
    ...
    window.title("DES")
    l=Label(window,text="DES",bg="red2",fg="white",font=("nunito",44,"bold"))
    l.place(x=550,y=10)
    ...
    l1=Label(window,text="*static plain text : '123456ABCD132536'",bg="white",fg="red2",font=("nunito",14,"bold","italic"))
    l1.place(x=330,y=180) 
     
    #e1 = Entry(window,width=25) 
    #e1.place(x=500 , y=130) 

    l2=Label(window,text="*static key : 'AABB09182736CCDD'",bg="white",fg="red2",font=("nunito",14,"bold","italic"))
    l2.place(x=330,y=220) 
    ...
    def encrypt(pt, rkb, rk): 
        ...
        listbox.insert(END, cipher_text)
   ...
   # key = e2.get()
    ...
    b9 = Button(window, text=" Cipher ",activeforeground="red2",activebackground="white",bg="red2",fg="white",bd=5,relief="ridge",width=6,height=1,font=("nunito",20,"bold"), command=lambda: encrypt(pt, rkb, rk)) 
